                        ...
                        <el-row>
                            ...
                            <el-form :inline="false" :model="form" class="demo-ruleForm" ref="form" label-position='right'>
                                ...
                                <el-form-item
                                        ...
                                        "
                                >
                                    <el-input type="id" v-model.number="form.siji_id" autocomplete="off" placeholder="请输入司机工号" style="width:50%" clearable></el-input>
                                </el-form-item>
    ...
    export default {
        ...
        methods:{
            ...
            post(data){
                // alert("hhhh");
                var this_ = this;
                this.axios.post('/api/query_sjwz/',
                    this.form)
                    .then(function(response){
                        ...
                        if (response.data == null){
                            ...
                            this_.axios.post('/api/query_sjwz_e/',this_.form)
                                .then(function(response){
                                    // console.log(response);
                                    this_.label_e = [];
                                    this_.data_e = [];
                                    for(var item in response.data){
                                        ...
                                        this_.data_e.push(response.data[item]["count(weizhang)"]);
                                    }
                                    this_.gogogo ();
